...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        $.jSlots.defaultOptions = {
            ...
            spinner : 'playNormal',        // CSS Selector: element to bind the start event to
            spinEvent : 'click', // String: event to start slots on this event
            onStart : 'showHidden()',    // Function: runs on spin start,
		...
		function showHidden(){
				$('div.hideUntilShown').show();
				console.log('hello, did this run?');
		}
